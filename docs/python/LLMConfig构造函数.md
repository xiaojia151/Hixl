...
Decode和Prompt可以双向拉取Cache。该模式下的相关接口包括：[enable\_cache\_manager](enable_cache_manager.md)、[mem\_pool\_cfg](mem_pool_cfg.md)和[listen\_ip\_info](listen_ip_info.md)。
