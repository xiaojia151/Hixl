...
<td class="cellrowborder" valign="top" width="35.870000000000005%" headers="mcps1.1.4.1.2 "><p id="p9541205974512"><a name="p9541205974512"></a><a name="p9541205974512"></a><a href="CacheDesc.md">CacheDesc</a></p>
</td>
...
<td class="cellrowborder" valign="top" width="41.91%" headers="mcps1.1.4.1.3 "><p id="p13710163018615"><a name="p13710163018615"></a><a name="p13710163018615"></a>Cache的地址。<a href="register_cache.md">register_cache</a>中的地址个数与<a href="register_blocks_cache.md">register_blocks_cache</a>的地址个数之和不超过240。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="35.870000000000005%" headers="mcps1.1.4.1.2 "><p id="p063416304569"><a name="p063416304569"></a><a name="p063416304569"></a>Union[Tuple[<a href="CacheKey.md">CacheKey</a>], List[<a href="CacheKey.md">CacheKey</a>]]</p>
</td>
...
D2D HCCS数据传输时，首地址需要按照2MB对齐，否则可能导致[link](link.md)失败，HCCS不支持Host内存。

RDMA数据传输时，申请Host内存必须通过aclrtMallocHost接口，否则可能导致[link](link.md)失败。
