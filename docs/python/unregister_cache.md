...
<td class="cellrowborder" valign="top" width="41.91%" headers="mcps1.1.4.1.3 "><p id="p1725416211412"><a name="p1725416211412"></a><a name="p1725416211412"></a>调用<a href="register_cache.md">register_cache</a>或<a href="register_blocks_cache.md">register_blocks_cache</a>返回的cache的id。</p>
</td>
</tr>
</tbody>
</table>
...
-   当前仅支持配置[local\_comm\_res](local_comm_res.md)场景使用。
-   调用该接口之前，需要先调用[unlink](unlink.md)进行断链，否则会导致HCCL报错。
