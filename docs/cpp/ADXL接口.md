# ADXL接口<a name="ZH-CN_TOPIC_0000002446743577"></a>
...
<td class="cellrowborder" valign="top" width="44.47%" headers="mcps1.1.4.1.3 "><p id="p10528111164114"><a name="p10528111164114"></a><a name="p10528111164114"></a>AdxlEngine标识，在所有参与建链的范围内需要确保唯一。格式为host_ip:host_port或host_ip，不建议配置为回环IP，在多个AdxlEngine交互场景，回环IP容易冲突。</p>
<p id="p8528111134120"><a name="p8528111134120"></a><a name="p8528111134120"></a>当设置host_port且host_port&gt;0时代表当前AdxlEngine作为Server端，需要对配置端口进行侦听。如果没设置host_port或者host_port&lt;=0代表是Client，不启动侦听。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59.36%" headers="mcps1.2.4.1.3 "><p id="p102815424519"><a name="p102815424519"></a><a name="p102815424519"></a>字符串取值"adxl.BufferPool"。</p>
...
<td class="cellrowborder" valign="top" width="59.36%" headers="mcps1.2.4.1.3 "><p id="p613920141278"><a name="p613920141278"></a><a name="p613920141278"></a>字符串取值"adxl.RdmaTrafficClass"。</p>
...
<td class="cellrowborder" valign="top" width="59.36%" headers="mcps1.2.4.1.3 "><p id="p1321144310716"><a name="p1321144310716"></a><a name="p1321144310716"></a>字符串取值"adxl.RdmaServiceLevel"。</p>
