...
if (NOT DEFINED ASCEND_3RD_LIB_PATH)
    set(ASCEND_3RD_LIB_PATH "${CMAKE_CURRENT_SOURCE_DIR}/build/third_party")
    file(MAKE_DIRECTORY "${ASCEND_3RD_LIB_PATH}")
endif()
message("ASCEND_3RD_LIB_PATH:${ASCEND_3RD_LIB_PATH}")
