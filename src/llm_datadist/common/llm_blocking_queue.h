...
#ifndef CANN_GRAPH_ENGINE_RUNTIME_LLM_DATADIST_V2_BLOCKING_QUEUE_H_
#define CANN_GRAPH_ENGINE_RUNTIME_LLM_DATADIST_V2_BLOCKING_QUEUE_H_
...
#endif  // CANN_GRAPH_ENGINE_RUNTIME_LLM_DATADIST_V2_BLOCKING_QUEUE_H_
