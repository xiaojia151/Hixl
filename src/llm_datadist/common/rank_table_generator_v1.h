...
class RankTableGeneratorV1 : public RankTableGenerator {
 public:
  RankTableGeneratorV1(const std::string &local_comm_res, const std::string &peer_comm_res)
 ...
 private:
  ...
  rank_table_v1::RankTableInfo merged_rank_table_;
};
}  // namespace llm
#endif  // CANN_GRAPH_ENGINE_RUNTIME_LLM_DATADIST_V2_RANK_TABLE_GENERATOR_V1_H_
