...
#ifndef CANN_GRAPH_ENGINE_RUNTIME_LLM_DATADIST_V2_STRING_UTIL_H_
#define CANN_GRAPH_ENGINE_RUNTIME_LLM_DATADIST_V2_STRING_UTIL_H_
...
#endif  // CANN_GRAPH_ENGINE_RUNTIME_LLM_DATADIST_V2_STRING_UTIL_H_
